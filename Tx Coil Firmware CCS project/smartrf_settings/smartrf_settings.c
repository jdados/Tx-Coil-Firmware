...
// Deviation: 0.000 kHz
// Fixed Packet Length: 2 
// Packet Length Config: Fixed 
// Max Packet Length: 255 
// Packet Data: 255 
// RX Filter BW: 98.0 kHz
// Symbol Rate: 39.99939 kBaud
// Sync Word Length: 32 Bits 
// TX Power: 10 dBm (requires define CCFG_FORCE_VDDR_HH = 1 in ccfg.c, see CC13xx/CC26xx Technical Reference Manual)
...
uint32_t pOverrides[] =
{
    ...
    (uint32_t)0x18000280,
    // override_phy_tc513_tx10dbm.xml
    ...
    // override_phy_ook_tx_power_10dbm_433M.xml
    // Tx: Ramp symbol shape to +10 dBm PA level (0x6D00). Explanation: min PA level=0x6100, ..., max PA level=0x7200. Bits [15:13] sets wait delay per PA ramp level. Bits[12:8] sets number of PA levels to use from ramp LUT (range 1-18). Bits[7:0] reserved.
    HW_REG_OVERRIDE(0x6098,0x6D00),
    // Tx: Set symbol duty-cycle delay before symbol ramp-down to 0xA7 (=167). This means symbol ramp down will begin after reaching (T_symbol/2) plus wait a delay of (167/2)=83 us.
